...
var (
	...
	errNone         = errors.New("okatype_version.None()")
	errNoneNullable = errors.New("okatype_version.NoneNullable()")
	errNull         = errors.New("okatype_version.Null()")
)
...
func (receiver NullableType) String() string {
	if NoneNullable() == receiver {
		return "okatype_version.NoneNullable()"
	}
	if Null() == receiver {
		return "okatype_version.Null()"
	}

	return fmt.Sprintf("okatype_version.SomeNullable(%d)", receiver.value)
}
...
func (receiver Type) String() string {
	if None() == receiver {
		return "okatype_version.None()"
	}

	return fmt.Sprintf("okatype_version.Some(%d)", receiver.value)
}
